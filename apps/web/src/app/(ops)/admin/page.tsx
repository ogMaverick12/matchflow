...
export default function AdminPage() {
  ...
  const [auditLogs, setAuditLogs] = useState<AuditLogEntry[]>([
    {
      id: 'log_1',
      action: 'System Init: Mercedes-Benz Stadium Concourse Graph Loaded',
      user: 'System',
      timestamp: Date.now() - 3600000,
    },
    {
      id: 'log_2',
      action: 'Assigned Role "volunteer" to Diego',
      user: 'Marcus (Organizer)',
      timestamp: Date.now() - 3200000,
    },
    {
      id: 'log_3',
      action: 'Assigned Role "staff" to Priya',
      user: 'Marcus (Organizer)',
      timestamp: Date.now() - 3100000,
    },
    {
      id: 'log_4',
      action: 'Incident clustered (inc_1) from volunteer report',
      user: 'Flow Engine (AI)',
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ padding: '12px' }}>
                        ...
                        >
                          {isOffDuty ? <Info size={10} /> : <CheckCircle size={10} />}
            ...
            {auditLogs
              ...
              .map((log) => (
                ...
                >
                  ...
                  <p style={{ margin: 0, color: 'var(--text-primary)', fontFamily: 'monospace' }}>
                    {log.action}
                  </p>
                </div>
              ))}
