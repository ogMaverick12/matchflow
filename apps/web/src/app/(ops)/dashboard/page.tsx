    ...
    try {
      ...
      if (ok) {
        setVerificationResult(
          `✅ PASS: server rejected fan read of incidents (HTTP ${status}). Access is enforced server-side in the API layer (Upstash-backed, role-verified tokens).`,
        );
      } else {
      ...
      <div style={{ padding: '24px' }}>
        ...
        >
          ...
          <h3
            ...
            style={{ margin: '0 0 8px 0', color: 'var(--alert-accent)', fontSize: '20px' }}
          >
    ...
    <div>
      ...
      >
        <div>
          <h2
            className="display-title"
            style={{ fontSize: '28px', fontWeight: 'bold', margin: '0 0 4px 0' }}
          >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span
              ...
              style={{
                fontSize: '28px',
                fontWeight: 'bold',
                color: activeIncidents.length > 0 ? 'var(--alert-accent)' : 'var(--text-primary)',
              }}
            >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span
              ...
              style={{
                fontSize: '28px',
                fontWeight: 'bold',
                color: highCongestionCount > 0 ? 'var(--primary-accent)' : 'var(--text-primary)',
              }}
            >
              {highCongestionCount}
            </span>
      ...
      >
        ...
        >
          This mints a throwaway <code>fan</code> session token and calls the protected{' '}
          <code>/api/db?coll=incidents</code> endpoint with it. Access control is enforced
          server-side in the API layer (Upstash-backed, role-verified tokens) — a fan must be
          rejected. (The legacy <code>firestore.rules</code> file remains only as documented
          reference for the Firebase deployment path.)
        </p>
