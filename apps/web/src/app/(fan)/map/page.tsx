    ...
    return (
      <div style={{ textAlign: 'center', padding: '48px 0' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '14px' }}>
          Establishing connection to Flow Engine
        </p>
      </div>
    );
  }
    ...
    return (
      ...
      >
        ...
        <h4
          ...
          style={{ margin: '0 0 8px 0', color: 'var(--alert-accent)', fontSize: '18px' }}
        >
          MAP CONNECTION LOST
        </h4>
        <p
      ...
      >
        ...
        <div
          style={{
            ...
            overflow: 'hidden',
            backgroundImage:
              'radial-gradient(circle, transparent 35%, rgba(16, 185, 129, 0.05) 36%)',
          }}
        >
          {zones.map((zone) => {
            ...
            return (
              ...
              >
                <span>{zone.zoneId.replaceAll('_', ' ')}</span>
                <span
                  className="numeric-glow"
                  style={{ fontSize: '15px', color: 'var(--primary-accent)', marginTop: '4px' }}
                >
