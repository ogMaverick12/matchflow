  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: '32px' }}>
        <h1 className="display-title" style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 8px 0' }}>
          MATCHFLOW
        </h1>
      ...
      {/* §9: h2 section heading — no skip from h1 */}
        <h2 style={{ fontSize: '18px', fontWeight: 'bold', margin: '0 0 16px 0', borderBottom: '1px solid var(--border-color)', paddingBottom: '8px', fontFamily: "'Space Grotesk', sans-serif" }}>
          Select Language
        </h2>
          ...
          {languages.map(lang => (
            <button
              ...
              style={{
                padding: '12px',
                borderRadius: '6px',
                backgroundColor: session.language === lang.code ? 'var(--primary-accent)' : 'var(--bg-surface-elevated)',
                color: session.language === lang.code ? '#000000' : 'var(--text-primary)',
                border: session.language === lang.code ? '2px solid var(--primary-accent)' : '1px solid var(--border-color)',
                fontWeight: 'bold',
                textAlign: 'center',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <label style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', cursor: 'pointer' }}>
            <input
              ...
              style={{ width: '20px', height: '20px', accentColor: 'var(--primary-accent)', marginTop: '2px' }}
            />
            <div>
              ...
              <span style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>Filters routes to elevators and ramps only</span>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', cursor: 'pointer' }}>
            ...
            <div>
              ...
              <span style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>Increases legibility in bright sunlight or dark tunnels</span>
            </div>
          </label>
          ...
          <label style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', cursor: 'pointer' }}>
            ...
            <div>
              ...
              <span style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>Short sentences, plain-language Q&A rewriting</span>
            </div>
          </label>
        </div>
      </div>
