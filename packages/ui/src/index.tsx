  ...
  return (
    <div style={cardStyle} className="route-card">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
        <h4 style={{ margin: 0, fontSize: '18px', fontWeight: 'bold', fontFamily: "'Space Grotesk', sans-serif" }}>
          {destinationName}
        </h4>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', fontSize: '15px', lineHeight: 1.5 }}>
        <div>
          <span style={{ display: 'block', color: '#94a3b8', fontSize: '12px', fontWeight: 'bold', marginBottom: '4px' }}>EST. TIME</span>
          <span style={{ fontWeight: 'bold', fontSize: '16px', color: '#fbbf24', fontVariantNumeric: 'tabular-nums' }}>
            {mins} min
          </span>
        </div>
        <div>
          <span style={{ display: 'block', color: '#94a3b8', fontSize: '12px', fontWeight: 'bold', marginBottom: '4px' }}>STOPS</span>
          <span style={{ fontWeight: 'bold', fontSize: '16px', fontVariantNumeric: 'tabular-nums' }}>
            {pathNodesCount} zones
          </span>
        </div>
        <div>
          <span style={{ display: 'block', color: '#94a3b8', fontSize: '12px', fontWeight: 'bold', marginBottom: '4px' }}>WAY MODE</span>
